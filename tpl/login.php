...
<form action="/login" method="post">
    ...
    <input type="text" name="mac" readonly style="width: 100%; height: 50px; text-align: center; border: none;font-size: xx-large; font-weight: bold" value="<?php echo $_GET['mac'] ?>">
